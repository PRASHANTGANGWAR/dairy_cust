...
/**
 * Generated class for the PendingsnoozedPage page.
 *
...
@Component({
  selector: 'page-pendingsnoozed',
  templateUrl: 'pendingsnoozed.html',
})
export class PendingsnoozedPage {
  private loading :any;
  AppUsers: any=[];
  queryText = '';
  ...
  constructor(
    ...
    private _loading: LoadingController
      ...
      this.pendingsnoozedPayments();
    }

  pendingsnoozedPayments() {
      this.showLoader();
      this.userData.pendingsnoozed_payments().then(results=>{
          let res : any ={};
          let result : any ={};
          res = results;
